...
namespace CsharpBot.Pages
{
    public partial class Index : ComponentBase
    {
        ...
        private readonly string _chatBotKnowledgeScope = "" +
            "Your name is GreenThumb, You are an assistant that help users learn how to properly maintain their yard and garden." +
            "When user's question is not related to yard and garden or landscaping, reply politely that you can not answer" +
